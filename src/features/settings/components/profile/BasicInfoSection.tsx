...
import { Scale, Ruler, Calendar, Target, Activity, TrendingDown, TrendingUp, Heart } from 'lucide-react';
...
export function BasicInfoSection({ data, onChange, unitSystem }: BasicInfoSectionProps) {
