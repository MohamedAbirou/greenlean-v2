...
import type { CalorieBalance, MacroDistribution, MealConsistency } from "../types/stats.types";
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${timeRange === "7d"
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${timeRange === "30d"
              ? "bg-primary text-white"
              : "bg-gray-100 text-muted-foreground hover:bg-gray-200"
              }`}
          >
        ...
        <div className="bg-card rounded-xl shadow-sm border border-border p-6">
          ...
          {filteredMacros.length > 0 ? (
            ...
            <div className="h-[200px] flex items-center justify-center text-muted-foreground">
              <p>No Macros data yet. Log your first meal!</p>
            </div>
          )}
        </div>
