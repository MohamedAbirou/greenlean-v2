...
export const buttonVariants = cva(
  'inline-flex items-center justify-center gap-x-2 rounded-lg cursor-pointer font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
